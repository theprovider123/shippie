...
export const themePalettes: ThemePalette[] = [
  {
    ...
    vars: {
      '--mode': 'light',
      '--bg': '#F2EAD8',
      '--bg-tint': 'rgba(216, 168, 122, 0.18)',
      '--paper': '#F8F1E0',
      '--paper-warm': '#F4E5C9',
      '--ink': '#2A1F16',
      '--ink-soft': '#4E3D2C',
      '--ink-faint': '#75614C',
      '--line': 'rgba(94, 63, 32, 0.16)',
      '--line-strong': 'rgba(94, 63, 32, 0.32)',
      '--accent': '#C8643A',
      ...
      '--leaf': '#7C9F86',
      '--sea': '#5A8FA0',
      '--shadow-soft': '0 12px 28px rgba(94, 63, 32, 0.12)',
      '--shadow-card': '0 18px 38px rgba(94, 63, 32, 0.14)',
      '--shadow-hero': '0 30px 60px rgba(94, 63, 32, 0.22)',
    },
  },
  {
    key: 'coast',
    ...
    vars: {
      '--mode': 'light',
      '--bg': '#EFE9D4',
      '--bg-tint': 'rgba(126, 138, 77, 0.18)',
      '--paper': '#F5F0DB',
      '--paper-warm': '#EBE1BE',
      '--ink': '#26271B',
      '--ink-soft': '#454936',
      '--ink-faint': '#6E7155',
      '--line': 'rgba(60, 64, 35, 0.18)',
      '--line-strong': 'rgba(60, 64, 35, 0.34)',
      '--accent': '#7E8A4D',
      ...
      '--leaf': '#7E8A4D',
      '--sea': '#5C7A6E',
      '--shadow-soft': '0 12px 28px rgba(60, 64, 35, 0.12)',
      '--shadow-card': '0 18px 38px rgba(60, 64, 35, 0.14)',
      '--shadow-hero': '0 30px 60px rgba(60, 64, 35, 0.2)',
    },
  },
  {
    key: 'garden',
    ...
    vars: {
      '--mode': 'light',
      '--bg': '#FAE8C8',
      '--bg-tint': 'rgba(224, 122, 60, 0.16)',
      '--paper': '#FDF1D6',
      '--paper-warm': '#F8DEAE',
      '--ink': '#3A1E0E',
      '--ink-soft': '#603823',
      '--ink-faint': '#8B6444',
      '--line': 'rgba(96, 56, 35, 0.18)',
      '--line-strong': 'rgba(96, 56, 35, 0.34)',
      '--accent': '#E07A3C',
      ...
      '--leaf': '#7A8E58',
      '--sea': '#5C8AA0',
      '--shadow-soft': '0 12px 28px rgba(96, 56, 35, 0.14)',
      '--shadow-card': '0 18px 38px rgba(96, 56, 35, 0.16)',
      '--shadow-hero': '0 30px 60px rgba(96, 56, 35, 0.24)',
    },
  },
  {
    key: 'night',
