 ...
 */
export type QuickFindCategory = 'toilet' | 'water' | 'station' | 'landmark' | 'atm';
...
const CHIP_ORDER: QuickFindCategory[] = ['toilet', 'water', 'station', 'landmark', 'atm'];
...
export function kindsForCategory(category: QuickFindCategory): RoutePoiKind[] {
  ...
  if (category === 'landmark') return ['landmark', 'meeting', 'medical', 'exit', 'stewards', 'view'];
