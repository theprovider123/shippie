 ...
 *
 * Mirrors `apps/showcase-recipe/src/db/runtime.ts`. Kept inline rather
 * than shared so each showcase remains a self-contained, deployable
 * Vite bundle.
 */
import type {
  LocalDbBackupInfo,
