/**
 * Resolve the local DB for Touch. Mirrors the journal pattern:
 * production gets `window.shippie.local.db`; dev/standalone falls back
 * to a minimal in-memory implementation.
 */
import type {
  LocalDbBackupInfo,
