...
export const curatedApps: ContainerApp[] = [
  ...
  },
  {
    ...
    standaloneUrl: '/run/habit-tracker',
  ...
  },
  {
    ...
    standaloneUrl: '/run/pantry-scanner',
    permissions: localPermissions('pantry-scanner', {
      provides: ['pantry-inventory', 'pantry-low'],
    }),
    category: 'cooking',
  ...
  },
  {
    ...
    name: 'Caffeine Log',
    shortName: 'Caffeine',
    description: 'Single tap to log a coffee, tea, or energy drink. Sleep Logger correlates the timing.',
    appKind: 'local',
    entry: 'app/index.html',
    labelKind: 'Local',
    icon: 'CA',
    ...
    standaloneUrl: '/run/caffeine-log',
    permissions: localPermissions('caffeine-log', { provides: ['caffeine-logged'] }),
    devUrl: 'http://localhost:5191/',
  },
  {
    id: 'app_hydration',
    slug: 'hydration',
    ...
    version: '1',
    packageHash: `sha256:${'b'.repeat(64)}`,
    standaloneUrl: '/run/hydration',
    permissions: localPermissions('hydration', {
      provides: ['hydration-logged'],
      consumes: ['cooked-meal'],
    }),
    devUrl: 'http://localhost:5192/',
  },
  {
    id: 'app_mood_pulse',
    slug: 'mood-pulse',
    ...
    version: '1',
    packageHash: `sha256:${'b'.repeat(64)}`,
    standaloneUrl: '/run/mood-pulse',
    permissions: localPermissions('mood-pulse', {
      provides: ['mood-logged'],
      consumes: ['caffeine-logged', 'workout-completed', 'sleep-logged'],
    }),
    devUrl: 'http://localhost:5193/',
  },
  {
    id: 'app_symptom_tracker',
    ...
    version: '1',
    packageHash: `sha256:${'b'.repeat(64)}`,
    standaloneUrl: '/run/symptom-tracker',
    permissions: localPermissions('symptom-tracker', {
      provides: ['symptom-logged'],
    }),
    devUrl: 'http://localhost:5194/',
  },
  {
    id: 'app_steps_counter',
    slug: 'steps-counter',
    name: 'Steps Counter',
    shortName: 'Steps',
    ...
    version: '1',
    packageHash: `sha256:${'b'.repeat(64)}`,
    standaloneUrl: '/run/steps-counter',
    permissions: localPermissions('steps-counter', {
      provides: ['walked'],
  ...
  },
  {
    ...
    version: '1',
    packageHash: `sha256:${'b'.repeat(64)}`,
    standaloneUrl: '/run/restaurant-memory',
    permissions: localPermissions('restaurant-memory', {
      provides: ['dined-out'],
      consumes: ['cooked-meal'],
    }),
  ...
  },
  {
    ...
    version: '1',
    packageHash: `sha256:${'b'.repeat(64)}`,
    standaloneUrl: '/run/show-and-tell',
    permissions: localPermissions('show-and-tell'),
