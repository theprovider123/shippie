...
const curatedAppSpecs: CuratedAppSpec[] = [
  ...
  },
  {
    ...
    port: 5251,
    intents: {
      provides: ['mood-logged', 'sleep-logged', 'hydration-logged', 'workout-completed', 'mindful-session', 'symptom-logged', 'body-metrics-logged'],
      consumes: ['cooked-meal', 'caffeine-logged', 'coffee-brewed', 'brewed-tea', 'wellness-ritual'],
    },
  },
  {
    slug: 'sleep',
  ...
  },
  {
    ...
    name: 'Cycle',
    shortName: 'Cycle',
    description: 'A private, local-only logbook for your cycle and body — honest predictions, no account, no servers.',
    appKind: 'local',
    icon: 'CY',
    accent: '#c0584c',
    category: 'health',
    port: 5211,
    intents: {
      provides: ['cycle-logged', 'period-started', 'cycle-window-predicted', 'symptom-pattern-detected'],
      consumes: ['mood-logged', 'sleep-logged', 'hydration-logged', 'caffeine-logged', 'body-metrics-logged', 'workout-completed'],
    },
  },
  {
    slug: 'symptom-diary',
