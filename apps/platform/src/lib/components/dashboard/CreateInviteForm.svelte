...
<style>
  ...
  label span { font-size: var(--text-caption); color: var(--text-secondary); font-family: ui-monospace, monospace; text-transform: uppercase; letter-spacing: 0.12em; }
  input { height: 40px; padding: 0 0.75rem; background: transparent; border: 1px solid var(--border-light); font-family: ui-monospace, monospace; font-size: var(--text-body); width: 140px; box-sizing: border-box; color: inherit; }
  button {
  ...
  .url { font-family: ui-monospace, monospace; font-size: var(--text-small); color: var(--sunset); margin: 0; word-break: break-all; }
  ...
  .error { color: var(--danger); font-size: var(--text-small); }
</style>
