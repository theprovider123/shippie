...
<style>
  ...
  .ok { color: #A8C491; }
  .empty { padding: 4rem 2rem; text-align: center; border: 1px dashed #3A352D; }
  h2 { font-family: 'Fraunces', Georgia, serif; }
  .list { display: grid; gap: 0; border-top: 1px solid #2A251E; }
  ...
  .meta span { border: 1px solid #3A352D; padding: 2px 7px; color: #EDE4D3; }
  .meta .declared { border-color: rgba(232, 197, 71, 0.45); color: #E8C547; }
  .reason { color: #EDE4D3; max-width: 76ch; margin: 0.7rem 0 0; padding: 0.6rem 0.8rem; background: rgba(232, 96, 60, 0.06); border-left: 3px solid #E8603C; }
  .muted { color: #8B847A; margin: 0.5rem 0 0; }
  small { color: #7A6B58; font-family: ui-monospace, monospace; font-size: 11px; display: block; margin-top: 0.5rem; }
  form { display: flex; flex-wrap: wrap; gap: 0.4rem; margin-top: 0.75rem; }
  button { border: 1px solid #3A352D; background: transparent; color: #EDE4D3; padding: 0.45rem 0.8rem; cursor: pointer; min-height: var(--touch-min, 44px); }
