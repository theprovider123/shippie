...
<style>
  ...
  .empty { padding: 4rem 2rem; text-align: center; border: 1px dashed var(--border-light); }
  h2 { font-family: 'Fraunces', Georgia, serif; }
  .list { display: grid; gap: 0; border-top: 1px solid var(--border-light); }
  ...
  .meta span { border: 1px solid var(--border-light); padding: 2px 7px; color: var(--text); }
  ...
  .muted { color: var(--text-secondary); margin: 0.5rem 0 0; }
  small { color: var(--text-light); font-family: var(--font-mono); font-size: var(--text-caption); display: block; margin-top: 0.5rem; }
  form { display: flex; flex-wrap: wrap; gap: 0.4rem; margin-top: 0.75rem; }
  button { border: 1px solid var(--border-light); background: transparent; color: var(--text); padding: 0.45rem 0.8rem; cursor: pointer; min-height: var(--touch-min, 44px); }
