...
import { writeWrapMeta, writeAppMeta } from '@/lib/deploy/kv';
...
export async function createWrappedApp(
  ...
  // Write the KV rows the Worker dispatches on. Must land before we return
