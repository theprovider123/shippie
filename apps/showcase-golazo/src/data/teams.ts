...
const ROSTER: Omit<Team, "seed">[] = [
  ...
  { id: "SWE", name: "Sweden", short: "SWE", flag: "🇸🇪", colors: ["#006aa7", "#fecc02"], confederation: "UEFA" },
  { id: "CZE", name: "Czechia", short: "CZE", flag: "🇨🇿", colors: ["#d7141a", "#11457e"], confederation: "UEFA" },
  { id: "SCO", name: "Scotland", short: "SCO", flag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", colors: ["#003087", "#ffffff"], confederation: "UEFA" },
  { id: "BIH", name: "Bosnia & Herz.", short: "BIH", flag: "🇧🇦", colors: ["#002395", "#fecb00"], confederation: "UEFA" },
  { id: "TUN", name: "Tunisia", short: "TUN", flag: "🇹🇳", colors: ["#e70013", "#ffffff"], confederation: "CAF" },
  // — Pot 4 —
  ...
  { id: "HAI", name: "Haiti", short: "HAI", flag: "🇭🇹", colors: ["#00209f", "#d21034"], confederation: "CONCACAF" },
  { id: "CUW", name: "Curaçao", short: "CUW", flag: "🇨🇼", colors: ["#002868", "#00aef0"], confederation: "CONCACAF" },
  { id: "CPV", name: "Cape Verde", short: "CPV", flag: "🇨🇻", colors: ["#003893", "#cf2027"], confederation: "CAF" },
  { id: "COD", name: "DR Congo", short: "COD", flag: "🇨🇩", colors: ["#007fff", "#f7d000"], confederation: "CAF" },
];
