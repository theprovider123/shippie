// Local shim for `bun:test` — the CLI package uses Bun as its test runner but
// intentionally avoids installing @types/bun to keep the public dependency
// surface small. This shim covers the slice of the bun:test API used by
// command tests. Extend as needed.
