...
- [ ] `styles.css` rewritten from the token table in the spec (Georgia stack `Georgia, 'Times New Roman', serif`; system sans stack). 0.5px borders via `border-width: 0.5px` (renders as hairline on retina; acceptable 1px on 1x).
